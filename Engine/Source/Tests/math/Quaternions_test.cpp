...
namespace math_tests {
    ...
    TEST(QuaternionTests, VectorRotation)
    {
        ...
        ASSERT_TRUE(result == Vector3(std::cosf(ToRadians(45)), std::sinf(ToRadians(45)), 0));
        ...
        ASSERT_TRUE(result == Vector3(0, std::cosf(ToRadians(60)), std::sinf(ToRadians(60))));
        ...
        quat = Quaternion(rotation);
        result = quat.Rotate(test);
        ASSERT_TRUE(result == Vector3(0, 0, -1));
    }
